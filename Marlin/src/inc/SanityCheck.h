...
#undef _TMC_MICROSTEP_IS_VALID
  ...
  #define K_ENDSTOP_INVERTING !AXIS_DRIVER_TYPE(K,TMC2209)
  ...
  #elif I_SENSORLESS && I_HOME_DIR < 0 && NONE(ONBOARD_ENDSTOPPULLUPS, ENDSTOPPULLUPS, ENDSTOPPULLUP_ZMIN)
    #error "SENSORLESS_HOMING requires ENDSTOPPULLUP_ZMIN (or ENDSTOPPULLUPS) when homing to I_MIN."
  #elif I_SENSORLESS && I_HOME_DIR > 0 && NONE(ONBOARD_ENDSTOPPULLUPS, ENDSTOPPULLUPS, ENDSTOPPULLUP_ZMAX)
    #error "SENSORLESS_HOMING requires ENDSTOPPULLUP_ZMAX (or ENDSTOPPULLUPS) when homing to I_MAX."
  #elif J_SENSORLESS && J_HOME_DIR < 0 && NONE(ONBOARD_ENDSTOPPULLUPS, ENDSTOPPULLUPS, ENDSTOPPULLUP_ZMIN)
    #error "SENSORLESS_HOMING requires ENDSTOPPULLUP_ZMIN (or ENDSTOPPULLUPS) when homing to J_MIN."
  #elif J_SENSORLESS && J_HOME_DIR > 0 && NONE(ONBOARD_ENDSTOPPULLUPS, ENDSTOPPULLUPS, ENDSTOPPULLUP_ZMAX)
    #error "SENSORLESS_HOMING requires ENDSTOPPULLUP_ZMAX (or ENDSTOPPULLUPS) when homing to J_MAX."
  #elif K_SENSORLESS && K_HOME_DIR < 0 && NONE(ONBOARD_ENDSTOPPULLUPS, ENDSTOPPULLUPS, ENDSTOPPULLUP_ZMIN)
    #error "SENSORLESS_HOMING requires ENDSTOPPULLUP_ZMIN (or ENDSTOPPULLUPS) when homing to K_MIN."
  #elif K_SENSORLESS && K_HOME_DIR > 0 && NONE(ONBOARD_ENDSTOPPULLUPS, ENDSTOPPULLUPS, ENDSTOPPULLUP_ZMAX)
    #error "SENSORLESS_HOMING requires ENDSTOPPULLUP_ZMAX (or ENDSTOPPULLUPS) when homing to K_MAX."
    ...
    #endif
  #elif I_SENSORLESS && I_HOME_DIR < 0 && I_MIN_ENDSTOP_INVERTING != I_ENDSTOP_INVERTING
    ...
    #endif
  #elif I_SENSORLESS && I_HOME_DIR > 0 && I_MAX_ENDSTOP_INVERTING != I_ENDSTOP_INVERTING
    #if I_ENDSTOP_INVERTING
    ...
    #endif
  #elif J_SENSORLESS && J_HOME_DIR < 0 && J_MIN_ENDSTOP_INVERTING != J_ENDSTOP_INVERTING
    ...
    #endif
  #elif J_SENSORLESS && J_HOME_DIR > 0 && J_MAX_ENDSTOP_INVERTING != J_ENDSTOP_INVERTING
    #if J_ENDSTOP_INVERTING
    ...
    #endif
  #elif K_SENSORLESS && K_HOME_DIR < 0 && K_MIN_ENDSTOP_INVERTING != K_ENDSTOP_INVERTING
    ...
    #endif
  #elif K_SENSORLESS && K_HOME_DIR > 0 && K_MAX_ENDSTOP_INVERTING != K_ENDSTOP_INVERTING
    #if K_ENDSTOP_INVERTING
  ...
  #elif !(X_SENSORLESS || Y_SENSORLESS || Z_SENSORLESS  || I_SENSORLESS || J_SENSORLESS || K_SENSORLESS)
    #error "SENSORLESS_HOMING requires a TMC stepper driver with StallGuard on X, Y, Z, I, J or K axes."
  #endif
